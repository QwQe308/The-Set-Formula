addLayer("ac", {
	...
	milestones: {
		...
		5: {
			...
			effectDescription: ">———————————————————————————————————————————————————————————————————————————————————————————————————————————<<br>完全重置目标,A能量,阿尔法能量,B能量,轮盘,压缩点数(保留压缩点数解锁)<br><br>轮盘能量获取可以超出上限,但是超出上限的部分将降低轮盘能量获取<br>改善t<sub>2</sub>获取<br><br>一次可以获得100级的进化<br>自动购买阿尔法能量<br>B能量不再重置A能量以及进化<br>阿尔法能量不再重置任何<br>>———————————————————————————————————————————————————————————————————————————————————————————————————————————<",
		...
		6: {
			...
			effectDescription: ">———————————————————————————————————————————————————————————————————————————————————————————————————————————<<br>完全重置目标,A能量,阿尔法能量,B能量,轮盘,压缩点数(保留压缩点数解锁)<br><br>B以平方的数量影响b<br>timewall以绝对值计算公式<br>CoP的乘数因数变为指数<br>阿尔法能量可以超过300,但是超出的部分消耗极大程度增长<br><br>B能量不再重置轮盘<br>你可以最大购买A能量<br>你可以批量转最大5次轮盘<br>>———————————————————————————————————————————————————————————————————————————————————————————————————————————<",
